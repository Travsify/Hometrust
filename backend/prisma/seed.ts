...
async function main() {
    ...
    data: [
      {
        ...
        service: 'PAYSTACK',
        keyType: 'SECRET',
        keyValue: process.env.PAYSTACK_SECRET_KEY || 'sk_test_paystack_secret_sample',
        environment: 'LIVE',
  ...
  // 3. Developers (Only real registered developers from app/portal will exist)
  const devUsersData: any[] = [];
