...
class _RealEstateDictionaryScreenState extends State<RealEstateDictionaryScreen> {
  ...
  final List<Map<String, dynamic>> _masterDictionary = [
    ...
    },
    {
      ...
      'keywords': 'escrow account milestone disbursement protected funds security custody'
    },
    {
      'term': 'Excision',
      'category': '📜 Titles & Deeds',
    ...
    // === V ===
    {
      ...
      'category': '💰 Finance & Escrow',
      'definition': 'A unique, automated, dedicated bank account number generated specifically mapped to an individual or corporate user wallet for escrow funding.',
      ...
      'keywords': 'virtual account nuban bank transfer escrow automated'
    },
