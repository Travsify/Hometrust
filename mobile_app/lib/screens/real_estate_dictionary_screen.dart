...
class _RealEstateDictionaryScreenState extends State<RealEstateDictionaryScreen> {
  ...
  final List<Map<String, dynamic>> _masterDictionary = [
    ...
    // === M ===
    {
      ...
      'nigerianContext': 'HomeVerify provides the certified Nigerian Material Index to prevent developer invoice padding and ensure transparent construction budgeting.',
    ...
    // === V ===
    {
      ...
      'nigerianContext': 'Allows instant bank transfers from any Nigerian banking app, with automatic credit and reconciliation in the HomeVerify app.',
  ...
  void _triggerAiSearchDefinition(String customWord) async {
    ...
    try {
      final prompt = '''
You are the Lead Nigerian Real Estate Conveyancing Solicitor and Senior Land Surveyor for HomeVerify.
